...
import './App.css';
import { API, normalizeEvent, normalizeAnnouncement, normalizePaymentOption } from './api';
...
const LandingPage = () => {
  ...
  const handleMemberClick = () => navigate('/Homepage');
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      ...
      try {
        ...
        setEvents(sortedEvents.map(normalizeEvent));
      } catch (error) {
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/adminLogs" element={<PrivateRoute><Admin_Logs /></PrivateRoute>} />
          ...
          <Route path="/editAnnouncements" element={<PrivateRoute><EditAnnouncements /></PrivateRoute>} />
          <Route path="/editPaymentOptions" element={<PrivateRoute><EditPaymentOptions /></PrivateRoute>} />
          <Route path="/memberManagement" element={<PrivateRoute><MemberManagement /></PrivateRoute>} />
        </Routes>
      </Router>
    </AuthProvider>
  );
