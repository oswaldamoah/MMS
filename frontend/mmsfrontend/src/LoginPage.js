    ...
    <div className="login-section"> 
      <form className="form-control" onSubmit={handleSubmit}> 
        ...
        <div className="input-field"> 
          <input required className="input" type="text" name="username" placeholder="Enter Username" /> 
          <label className="label" htmlFor="username">Username</label> 
        </div> 
        <div className="input-field"> 
          <input required className="input" type="password" name="password" placeholder="Enter Password" /> 
